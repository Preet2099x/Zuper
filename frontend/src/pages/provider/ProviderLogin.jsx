    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-gray-100 p-6">
      ...
      >
        <header className="mb-4 text-center">
          <h1 className="text-2xl font-semibold">Welcome back, Provider</h1>
        ...
        <p className="mt-6 text-center text-sm text-gray-600">Don't have an account? <button onClick={() => nav('/provider/signup')} className="text-blue-600 hover:underline">Sign up</button></p>
      </motion.div>
    </div>
  );
}
