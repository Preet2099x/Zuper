...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-pink-50 p-4 relative overflow-hidden">
      <div className="absolute top-20 left-20 w-40 h-40 bg-yellow-400 border-4 border-black transform -rotate-12 hidden lg:block"></div>
      <div className="absolute bottom-20 right-20 w-32 h-32 bg-lime-400 border-4 border-black rounded-full hidden md:block"></div>
      <div className="absolute top-1/3 right-10 w-20 h-20 bg-cyan-400 border-4 border-black transform rotate-45 hidden lg:block"></div>
          ...
          <>
            <div className="text-center mb-6">
              <Link to="/" className="inline-block mb-4">
                <span className="brutal-badge bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 text-2xl inline-block">
                  ZUPER
                </span>
              </Link>
            ...
            <div className="brutal-card bg-white p-8">
              ...
              <form onSubmit={handleSignup} className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-4 border-3 border-black font-bold focus:outline-none focus:ring-4 focus:ring-pink-400 uppercase placeholder:normal-case"
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-4 border-3 border-black font-bold focus:outline-none focus:ring-4 focus:ring-pink-400 lowercase placeholder:normal-case"
                      required
                    />
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute right-3 top-1/2 -translate-y-1/2 font-black text-xs uppercase border-2 border-black bg-pink-300 px-2 py-1 hover:bg-pink-400"
                      >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="brutal-btn w-full bg-gradient-to-r from-pink-500 to-red-500 hover:from-pink-600 hover:to-red-600 text-white py-4 text-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ? (
              ...
              <div className="mt-6">
                ...
                <div className="mt-4">
                  <button className="brutal-btn bg-white hover:bg-gray-50 text-black py-3 flex items-center justify-center gap-2 w-full">
              ...
              <p className="mt-6 text-center font-bold">
                ...
                <button 
                  ...
                  className="font-black uppercase text-sm underline hover:text-pink-600"
                >
                  Login here! 
                </button>
              </p>
            ...
            <div className="text-center mt-6">
              <Link to="/" className="brutal-btn bg-cyan-400 hover:bg-cyan-300 text-black px-6 py-3 inline-block">
                 BACK TO HOME
              </Link>
            </div>
          </>
        ...
        {step === "verify" && (
          <div className="brutal-card bg-white p-8">
            <div className="text-center mb-6">
              ...
              <p className="font-bold text-gray-700">
                We sent a 6-digit code to <span className="text-pink-600">{form.email}</span>
              </p>
            </div>
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  placeholder="000000"
                  maxLength="6"
                  className="w-full p-4 border-3 border-black font-bold text-2xl text-center tracking-widest focus:outline-none focus:ring-4 focus:ring-pink-400 placeholder:text-gray-300"
                  required
                />
              </div>
